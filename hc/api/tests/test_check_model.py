...
class CheckModelTestCase(TestCase):
    ...
    def test_it_strips_tags(self):
        ...
        check.tags = "        "
        ### Repeat above test for when check is an empty string DONE
    ...
    def test_status_works_with_grace_period(self):
        ...
        ### The above 2 asserts fail. Make them pass DONE
    ...
    ### Test that when a new check is created, it is not in the grace period DONE
